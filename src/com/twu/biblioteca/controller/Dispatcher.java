...
public class Dispatcher {
    ...
    public void dispatch(String choice, User currentUser) {
            switch (choice) {
                case "0":
                ...
                case "7":
                    if(currentUser.isAdmin()) {
                        ...
                        view.printMessage("-----------------------------------------------------------------------------------\n");
                        view.printHashMapBook(bookLibrary.getCheckoutList());
                    }
                    else {
                ...
                case "8":
                    if (currentUser.isAdmin()) {
                        ...
                        view.printMessage(String.format("\n%-10s %-10s %-20s %-20s %-20s %-20s", "Library No", "Name", "Movie Title", "Year published", "Director", "Movie Rating\n"));
                        view.printMessage("------------------------------------------------------------------------------------\n");
